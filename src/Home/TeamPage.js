    ...
    <div className="team-page">
      <header className="header">
        <h1 className='team-heading'>
          <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774548/mark_pixnvc.png" alt='mark' className='mark' width={35} height={35}/>
      ...
      <section className="team-members">
        <div className="team-card sairam">
          <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774554/sairam_ytasss.png" alt="Uppugundla Sairam" className="profile-pic" />
          ...
          <a href="https://www.instagram.com/sairamuppugandla?igsh=MWVub3o5OXFvZWhvdA==" target="_blank" rel="noreferrer">
              <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774542/insta_bnvaeq.png" alt="Instagram" />
            </a>
            <a href="https://www.linkedin.com/in/sairam-uppugundla/" target="_blank" rel="noreferrer">
              <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774545/linkedin_adxx8a.png" alt="LinkedIn" />
            </a>
            <a href="https://wa.me/message/V6KW6C7XJG6FK1" target="_blank" rel="noreferrer">
              <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774563/whatsapp_mk3wpu.png" alt="whatsapp" />
            </a>
        ...
        <div className="team-card saketh">
          <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774554/saketh_r1l6g9.png" alt="Kallepu Saketh Reddy" className="profile-pic" />
          ...
          <a href="https://www.instagram.com/codewithsaketh?igsh=MTh4eXIzd21kaHRhYQ==" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.linkedin.com/in/saketh-codegnan/" target="_blank" rel="noreferrer">
              <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774545/linkedin_adxx8a.png" alt="LinkedIn" width={30} height={30}/>
            </a>
            <a href="https://wa.me/message/V6KW6C7XJG6FK1" target="_blank" rel="noreferrer">
              <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774563/whatsapp_mk3wpu.png" alt="whatsapp" />
            </a>
      ...
      <section className="description">
        ...
        <ul>
          <li>
          <img src="https://res.cloudinary.com/db2bpf0xw/image/upload/v1734774560/tick-mark_tasdhm.png" alt="tickMark" className='tick-mark'/>
